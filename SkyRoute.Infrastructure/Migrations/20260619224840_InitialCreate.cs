        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EconomyBasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BusinessBasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FirstClassBasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EconomyAvailable = table.Column<int>(type: "int", nullable: false),
                    BusinessAvailable = table.Column<int>(type: "int", nullable: false),
                    FirstClassAvailable = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_FlightScheduleId_FlightDate",
                table: "Flights",
                columns: new[] { "FlightScheduleId", "FlightDate" },
                unique: true);
